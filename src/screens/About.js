...
const About = () => {
  ...
  return (
    <View style={styles.aboutContainer}>
      <Text style={styles.mainHeader}> Ankit Kumar Suman </Text>
      ...
      <View style={styles.menuContainer}>
        <TouchableOpacity
          ...
          onPress={() =>
            Linking.openURL("https://www.instagram.com/ankitkr3478")
          }>
          <Image
        ...
        <TouchableOpacity
          style={styles.buttonStyle}
          onPress={() => Linking.openURL("https://twitter.com/ankitkr99")}>
          <Image
            style={styles.iconStyle}
            source={{
        ...
        <TouchableOpacity
          style={styles.buttonStyle}
          onPress={() => Linking.openURL("https://www.linkedin.com/in/ankit-kumar-suman-694866167")}>
          <Image
            style={styles.iconStyle}
            source={{
              uri: "https://cdn-icons-png.flaticon.com/512/2111/2111499.png",
            }}
          />
        </TouchableOpacity>
      </View>
